...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(304, "Семантическая ошибка: Объявление переменной без ключевого слова type"),
		...
		ERROR_ENTRY(309, "Семантическая ошибка: Несоответствие передаваемых параметров в функцию"),
		ERROR_ENTRY(310, "Семантическая ошибка: Несоответствие арифметических операторов"),
		ERROR_ENTRY(311, "Семантическая ошибка: Неправильный параметр в условном операторе"),
		ERROR_ENTRY(312, "Семантическая ошибка: Несоответствие типов данных"),
		ERROR_ENTRY_NODEF(313),
		ERROR_ENTRY(314, "Семантическая ошибка: Функция возвращает несоответствующий тип данных"),
		...
		ERROR_ENTRY(607, "Синтаксическая ошибка: Ошибка в условном операторе"),
